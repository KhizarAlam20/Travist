...
class rcvAdapter (var hotelDetails : ArrayList<hotelDetailClass>) : RecyclerView.Adapter<rcvAdapter.exampleViewHolder>() {
   ...
   lateinit var mlistner : onItemClickListner
    ...
    class exampleViewHolder(itemView: View, listner :onItemClickListner) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): exampleViewHolder {
       val view = LayoutInflater.from(parent.context).inflate(R.layout.rcv_item,parent,false)
        return exampleViewHolder(view,mlistner)
    }
